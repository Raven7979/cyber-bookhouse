...
class UpdateSkillTests(unittest.TestCase):
    def test_latest_release_requires_build_marker_and_digest(self) -> None:
        payload = {
            "tag_name": "v0.2.2",
            "body": "<!-- cyber-bookhouse-build: 2 -->",
            "draft": False,
            "prerelease": False,
            "html_url": "https://github.com/Raven7979/cyber-bookhouse/releases/tag/v0.2.2",
            "assets": [
                {
                    "name": "cyber-bookhouse.zip",
                    "state": "uploaded",
                    "digest": f"sha256:{'a' * 64}",
                    "browser_download_url": "https://github.com/Raven7979/cyber-bookhouse/releases/download/v0.2.2/cyber-bookhouse.zip",
                }
            ],
        }
        ...
        self.assertEqual(release["build"], 2)
    ...
    def test_apply_update_replaces_installed_skill_and_keeps_backup(self) -> None:
        with tempfile.TemporaryDirectory() as folder:
            ...
            (installed / "release.json").write_text(
                json.dumps({"version": "0.2.2", "build": 1}),
                encoding="utf-8",
            )
            ...
            release = {
                ...
                "build": 2,
                "tag": "v0.2.2",
                "download_url": "https://github.com/Raven7979/cyber-bookhouse/releases/download/v0.2.2/cyber-bookhouse.zip",
                "sha256": "unused-by-mocked-download",
                "release_url": "https://github.com/Raven7979/cyber-bookhouse/releases/tag/v0.2.2",
            }
